...
export class GovernorCompTestnet__proposalVotesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class GovernorCompTestnet extends ethereum.SmartContract {
  static bind(address: Address): GovernorCompTestnet {
    return new GovernorCompTestnet("GovernorCompTestnet", address);
  }
  ...
  proposalVotes(proposalId: BigInt): GovernorCompTestnet__proposalVotesResult {
    let result = super.call(
      "proposalVotes",
    ...
    return new GovernorCompTestnet__proposalVotesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_proposalVotes(
    proposalId: BigInt
  ): ethereum.CallResult<GovernorCompTestnet__proposalVotesResult> {
    let result = super.tryCall(
      "proposalVotes",
      "proposalVotes(uint256):(uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(proposalId)]
    ...
    return ethereum.CallResult.fromValue(
      new GovernorCompTestnet__proposalVotesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
